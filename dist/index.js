function JSXDogCreateElement(element, properties) {
    var children = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        children[_i - 2] = arguments[_i];
    }
    var el = new element(properties);
    children && children.filter(function (el) { return el !== undefined; }).forEach(function (child) {
        el.addChild(child);
    });
    return el;
}
...
var nilloElem = document.querySelector('.jsx-illo');
...
function Hat() {
    return JSXDogCreateElement(Zdog.Anchor, { translate: { y: -8 } },
        JSXDogCreateElement(Zdog.Shape, { path: [hatFrontA, hatFrontB, hatFrontC, hatFrontD], color: colors.cloth, closed: false, fill: false, stroke: 11 }));
}
function Head(_a) {
    var color = _a.color;
    return JSXDogCreateElement(Zdog.Shape, { translate: { y: -12, z: 1 }, color: color, stroke: 23 },
        JSXDogCreateElement(Zdog.Shape, { translate: { y: 5, z: 13 }, color: color, stroke: 7 }),
        JSXDogCreateElement(Zdog.Shape, { path: [
                { x: -5, y: 6, z: 4 },
                { x: 0, y: 8.5, z: 6 }
        ...
        JSXDogCreateElement(Mouth, { color: colors.cloth }),
        JSXDogCreateElement(Hat, null));
}
function Mouth(_a) {
    var color = _a.color;
    return JSXDogCreateElement(Zdog.Shape, { path: [
            { x: -3, y: -3 },
            { x: -1, y: -1 },
            { x: 1, y: -1 },
            { x: 3, y: -3 },
        ], translate: { y: 12, z: 9 }, color: color, fill: true, stroke: 2, addTo: head });
}
var nIllo = JSXDogCreateElement(Zdog.Illustration, { element: ".jsx-illo", zoom: zoom, dragRotate: true, onDragStart: function () { isSpinning = false; } },
    JSXDogCreateElement(Head, { color: colors.skin }));
// hat front
new Zdog.Shape({
    path: [
        hatFrontA,
